...
#define FONT_SIZE_GOODSNAME 15.f
#define FONT_SIZE_GOODSDESCRIBE 12.f
#define FONT_SIZE_GOODSMEMBERS 9.f
#define FONT_SIZE_GOODSMEMBERSPRICE 15.f
#define FONT_SIZE_GOODSPRICE 10.f
...
- (void) initDataCell
{
    ...
    _goodsNameLabel.font = [UIFont fontWithName:@"HelveticaNeue-Bold" size:FONT_SIZE_GOODSNAME];
    ...
    // 简介
    _goodsDescribeLabel = [[UILabel alloc] initWithFrame:CGRectMake(LABELORIGIN_X, 30, 181, 35)];
    // 自动折行
    _goodsDescribeLabel.lineBreakMode =NSLineBreakByCharWrapping;
    _goodsDescribeLabel.numberOfLines = 0;
    _goodsDescribeLabel.font = [UIFont fontWithName:@"HelveticaNeue-Bold" size:FONT_SIZE_GOODSDESCRIBE];
    ...
    _goodsMembersLabel.font = [UIFont fontWithName:@"HelveticaNeue-Bold" size:FONT_SIZE_GOODSMEMBERS];
    ...
    // 会员价格
    _goodsMembersPriceLabel = [[UILabel alloc] initWithFrame:CGRectMake(LABELORIGIN_X + _goodsMembersLabel.frame.size.width, LABELORIGIN_Y - 5, 22, 21)];
    _goodsMembersPriceLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:FONT_SIZE_GOODSMEMBERSPRICE];
    ...
    _goodsNoMembersLabel.font = [UIFont fontWithName:@"HelveticaNeue-Bold" size:FONT_SIZE_GOODSMEMBERS];
    ...
    // 非会员价格
    _goodsNoMembersPriceLabel = [[UILabel alloc] initWithFrame:CGRectMake(LABELORIGIN_X + _goodsMembersLabel.frame.size.width + _goodsMembersPriceLabel.frame.size.width + _goodsNoMembersLabel.frame.size.width, LABELORIGIN_Y - 5, 22, 21)];
    _goodsNoMembersPriceLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:FONT_SIZE_GOODSMEMBERSPRICE];;
    ...
    _goodsSoriginalLabel.font = [UIFont fontWithName:@"HelveticaNeue-Bold" size:FONT_SIZE_GOODSMEMBERS];
    ...
    _goodsSoriginalPriceLabel.font = [UIFont fontWithName:@"HelveticaNeue-Bold" size:FONT_SIZE_GOODSPRICE];
